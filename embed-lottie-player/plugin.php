...
if ( function_exists( 'lpb_fs' ) ) {
	...
	define( 'LPB_VERSION', isset( $_SERVER['HTTP_HOST'] ) && ( 'localhost' === $_SERVER['HTTP_HOST'] || 'plugins.local' === $_SERVER['HTTP_HOST'] ) ? time() : '1.2.4' );
		...
		class LPBPlugin{
			...
			function pluginActionLinks( $links, $file ) {
				if( plugin_basename( __FILE__ ) === $file ) {
					$helpDemosLink = admin_url( LPB_HAS_PRO ? 'edit.php?post_type=lpb&page=lottie-player#/welcome' : 'tools.php?page=lottie-player#/welcome' );

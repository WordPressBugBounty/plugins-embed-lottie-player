...
class LPBCustomPost{
	...
	function adminEnqueueScripts( $hook ){
		if( 'edit.php' === $hook || 'post.php' === $hook ){
			wp_enqueue_style( 'lpb-admin-post', LPB_DIR_URL . 'dist/admin-post.css', [], LPB_VERSION );
			wp_enqueue_script( 'lpb-admin-post', LPB_DIR_URL . 'dist/admin-post.js', [], LPB_VERSION, true );
